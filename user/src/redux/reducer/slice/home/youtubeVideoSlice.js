...
const youtubeVideo = createSlice({
    name: "youtubeVideo",
    initialState: initialState,
    reducers: {
        getYoutubeVideo: (state) => {
...
export const youtubeVideoActions = youtubeVideo.actions;
export const youtubeVideoReducers = youtubeVideo.reducer;