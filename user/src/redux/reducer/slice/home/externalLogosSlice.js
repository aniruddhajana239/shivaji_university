...
const externalLogos = createSlice({
    name: "externalLogos",
    initialState: initialState,
    reducers: {
        getExternalLogos: (state) => {
...
export const externalLogosActions = externalLogos.actions;
export const externalLogosReducers = externalLogos.reducer;