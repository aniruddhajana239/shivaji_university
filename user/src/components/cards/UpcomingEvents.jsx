...
export const UpcomingEventsCard = () => {
    ...
    const [expandedCategory, setExpandedCategory] = useState(uniqueCategories[0]);
                    ...
                    return (
                        <div key={category} className="flex flex-col">
                            ...
                            <button
                                ...
                                className={`cursor-pointer w-full flex items-center justify-between gap-2 p-2 ${(index !== uniqueCategories.length - 1&&expandedCategory!==category) && "border-b-[2px] border-[#D8D8D8]"}`}
                            >
