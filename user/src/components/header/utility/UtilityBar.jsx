...
export const UtilityBar = () => {
    return (
        <div className="w-full bg-[#077394] text-white px-[14px] lg:px-[48px] py-[8px] flex justify-between text-[14px]">
            {/* left section */}
            <div className="flex flex flex-col items-start gap-1 md:flex-row md:items-center md:gap-4">
                <a href="tel:(0231) 2609000" className="flex items-center gap-[5px]">
                    ...
                    <span className="text-white font-[200] text-[8px] lg:text-[12px]">(0231) 2609000</span>
                </a>
                <a href="mailto:contact@shivajiuniversity.com" className="flex items-center gap-[5px]">
                    ...
                    <span className="text-white font-[200] text-[8px] lg:text-[12px]">contact@shivajiuniversity.com</span>
                </a>
            </div>
            {/* right section */}
