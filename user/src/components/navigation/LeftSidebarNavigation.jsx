            ...
            <ul className="w-full flex flex-col">
                {navItems?.map((item) => (
                    <li 
                      ...
                      className={`cursor-pointer w-full text-left flex-shrink-0 text-[#000000] text-[14px] font-[400] py-1 rounded-[10px] ${activePath === item?.path && 'font-[600] flex items-center gap-1'}`}
                    >
                        {activePath === item?.path && (
                          <div className="w-5 h-5 rounded-full bg-[#C0F0FF] flex justify-center items-center">
